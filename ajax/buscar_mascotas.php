<?php
// ============================================================
// ajax/buscar_mascotas.php — Responde al AJAX de adoptar.php
// Recibe los filtros y devuelve las mascotas en formato JSON
// Requisito DWEC: archivo del servidor que responde a AJAX
// ============================================================
...
try {
    ...
    // Devolver JSON — igual que en la practica del profesor
    echo json_encode([
