<?php
// ============================================================
// index.php — Pagina principal de Huellas de Amor
// ============================================================
    ...
    <div class="contenedor">
                    ...
                    <div class="tarjeta-testimonio">
                        <div class="testimonio-img">
                            <img src="<?php echo $testimonio['foto_despues']
                                ...
                                : 'https://picsum.photos/400/300?random=' . $testimonio['id']; ?>"
                        ...
                        <div class="testimonio-cuerpo">
                            ...
                            <div class="testimonio-autor">
                                <img src="https://picsum.photos/40/40?random=<?php echo $testimonio['id_usuario']; ?>"
        ...
        <?php } else { ?>
            ...
            <div class="grid-testimonios">
                <div class="tarjeta-testimonio">
                    <div class="testimonio-img">
                        <img src="https://picsum.photos/400/300?random=21" alt="Testimonio">
                        <span class="badge-final-feliz">Final Feliz</span>
                    </div>
                    <div class="testimonio-cuerpo">
                        <p>"Adoptar a Bruno cambio mi vida por completo. Ahora tengo un compañero fiel para mis caminatas."</p>
                        <div class="testimonio-autor">
                            <img src="https://picsum.photos/40/40?random=1" alt="Carlos">
                            <div>
                ...
                <div class="tarjeta-testimonio">
                    <div class="testimonio-img">
                        <img src="https://picsum.photos/400/300?random=22" alt="Testimonio">
                        <span class="badge-final-feliz">Final Feliz</span>
                    </div>
                    <div class="testimonio-cuerpo">
                        <p>"Mimi llego asustada pero con amor y paciencia hoy es la reina de la casa."</p>
                        <div class="testimonio-autor">
                            <img src="https://picsum.photos/40/40?random=2" alt="Elena">
                            <div>
                ...
                <div class="tarjeta-testimonio">
                    <div class="testimonio-img">
                        <img src="https://picsum.photos/400/300?random=23" alt="Testimonio">
                        <span class="badge-final-feliz">Final Feliz</span>
                    </div>
                    <div class="testimonio-cuerpo">
                        <p>"Toby es el mejor regalo que nuestros hijos pudieron recibir. Nos enseño el valor de la lealtad."</p>
                        <div class="testimonio-autor">
                            <img src="https://picsum.photos/40/40?random=3" alt="Familia">
                            <div>
